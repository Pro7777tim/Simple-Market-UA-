...
public class MarketBuyMenu {

    public static ChestMenu create(int id, Inventory inv, int page) {

        SimpleContainer container = MarketManager.createBuyMenuContainer(page, (ServerPlayer) inv.player);
                ...
                if (slotId >= 0 && slotId < 54) {
                    ...
                    if (slotId == 45 && currentPage[0] > 0) {
                        ...
                        SimpleContainer newContainer =
                                MarketManager.createBuyMenuContainer(currentPage[0], (ServerPlayer) inv.player);
                    ...
                    if (slotId == 53) {
                        ...
                        int maxPage = (MarketManager.BUY_ITEMS.size() - 1)
                    ...
                    if (slotId < MarketManager.ITEMS_PER_PAGE) {
                        ...
                        if (realIndex >= MarketManager.BUY_ITEMS.size())
                            return;

                        SellEntry entry =
                                MarketManager.BUY_ITEMS.get(realIndex);
